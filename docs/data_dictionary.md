...
| `Tinh` | Mã tỉnh/thành | Tra tên ở `data/provinces.csv` |
...
Các cột tổ hợp chưa phải trọng tâm chính của phiên bản hiện tại. Đồ án tập trung vào thống kê và dự báo điểm trung bình theo môn, theo năm, theo tỉnh.
